...
namespace Sfs2X.Requests.Game
{
	public class QuickGameJoinRequest : BaseRequest
	{
		...
		public QuickGameJoinRequest(MatchExpression matchExpression, List<string> whereToSearch)
			: base(RequestType.QuickJoinGame)
		{
			Init(matchExpression, whereToSearch, null);
		}

		public QuickGameJoinRequest(MatchExpression matchExpression, List<string> whereToSearch, Room roomToLeave)
			: base(RequestType.QuickJoinGame)
		{
			Init(matchExpression, whereToSearch, roomToLeave);
		}

		public QuickGameJoinRequest(MatchExpression matchExpression, List<Room> whereToSearch)
			: base(RequestType.QuickJoinGame)
		{
			Init(matchExpression, whereToSearch, null);
		}

		public QuickGameJoinRequest(MatchExpression matchExpression, List<Room> whereToSearch, Room roomToLeave)
			: base(RequestType.QuickJoinGame)
		{
			Init(matchExpression, whereToSearch, roomToLeave);
		}
