...
public class BtnSelect_Item : MonoBehaviour
{
    ...
    public void SetTexture(int texture_id, Popup_Show.PopupType popup_type)
    {
        ...
        case Popup_Show.PopupType.Skills:
        {
            ...
            if (!string.IsNullOrEmpty(skillTexture) && img_item != null)
                SetGoodsCustomizeTexture(img_item, skill_texture_path + skillTexture);
            break;
        }
    ...
    public void UpdateNewMark(NewMarkType m_new_mark) { SetNewMark(img_new, m_new_mark); }
    public int         GetIndex()     { return index; }
    public string      GetIntroduce() { return popup_info.introduce; }
    public TUIPopupInfo GetInfo()     { return popup_info; }
