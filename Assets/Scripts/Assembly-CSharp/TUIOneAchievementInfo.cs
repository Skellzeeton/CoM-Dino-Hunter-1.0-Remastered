...
public class TUIOneAchievementInfo
{
	...
	public TUIOneAchievementInfo(int m_id, Dictionary<int, string> m_name_list, Dictionary<int, string> m_introduce_list, Dictionary<int, TUIAchievementRewardInfo> m_reward_list, Dictionary<int, int> m_progress_list, Dictionary<int, bool> m_take_reward_list)
	{
		id = m_id;
