...
public class Scene_Gold : MonoBehaviour
{
	...
	private void Start()
	{
		global::EventCenter.EventCenter.Instance.Publish(this, new TUIEvent.SendEvent_SceneGold("TUIEvent_TopBar"));
		if (top_bar != null)
		{
	...
	public void TUIEvent_SetUIInfo(object sender, TUIEvent.BackEvent_SceneGold m_event)
	{
		...
		else if (m_event.GetEventName() == "TUIEvent_GoldResult")
		{
	...
	public void TUIEvent_GoldBuy(TUIControl control, int event_type, float wparam, float lparam, object data)
	{
		if (event_type == 3)
		{
			...
			if (component != null)
			{
				...
				global::EventCenter.EventCenter.Instance.Publish(this, new TUIEvent.SendEvent_SceneGold("TUIEvent_GoldBuy", iD));
			}
		}
	}
	...
	public void TUIEvent_Back(TUIControl control, int event_type, float wparam, float lparam, object data)
	{
		if (event_type == 3)
		{
			...
			global::EventCenter.EventCenter.Instance.Publish(this, new TUIEvent.SendEvent_SceneGold("TUIEvent_Back"));
		}
	}
	...
	public void TUIEvent_IAP(TUIControl control, int event_type, float wparam, float lparam, object data)
	{
		if (event_type == 3)
		{
			...
			//global::EventCenter.EventCenter.Instance.Publish(this, new TUIEvent.SendEvent_SceneGold("TUIEvent_EnterIAP"));
		}
	}
	...
	public void TUIEvent_BtnCrystalNoEnough(TUIControl control, int event_type, float wparam, float lparam, object data)
	{
		if (event_type == 3)
		{
			...
			global::EventCenter.EventCenter.Instance.Publish(this, new TUIEvent.SendEvent_SceneGold("TUIEvent_EnterIAPCrystalNoEnough"));
		}
	}
