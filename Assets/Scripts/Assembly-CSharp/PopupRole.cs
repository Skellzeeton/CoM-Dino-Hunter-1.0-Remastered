...
public class PopupRole : MonoBehaviour
{
	...
	public void CheckScrollChoose()
	{
		...
		global::EventCenter.EventCenter.Instance.Publish(this, new TUIEvent.SendEvent_SceneTavern("TUIEvent_RolesChoose", id));
	}
