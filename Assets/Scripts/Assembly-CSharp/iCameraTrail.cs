...
public class iCameraTrail : iCamera
{
    ...
    private Vector3 camera_offset_normal = new Vector3(1.15f, 2.2f, -2.6f);
    private Vector3 camera_offset_shoot  = new Vector3(1f,  2f, -1.4f);
    ...
    protected float yawSmoothTime = 0.0166f;
    protected float pitchSmoothTime = 0.0166f;
