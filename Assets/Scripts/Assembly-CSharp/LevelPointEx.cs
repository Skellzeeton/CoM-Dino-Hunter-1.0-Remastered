...
public class LevelPointEx : MonoBehaviour
{
	...
	public void SetDefaultIcon()
	{
		...
		{
			img_icon_normal.texture = texture_killing02;
			img_icon_press.texture = texture_killing02;
			img_icon_disable.texture = texture_killing02;
		}
		else if (level_point_ex_type == LevelPointExType.Defended)
		{
			img_icon_normal.texture = texture_defended02;
			img_icon_press.texture = texture_defended02;
			img_icon_disable.texture = texture_defended02;
		}
		else if (level_point_ex_type == LevelPointExType.Steal)
		{
			img_icon_normal.texture = texture_steal02;
			img_icon_press.texture = texture_steal02;
