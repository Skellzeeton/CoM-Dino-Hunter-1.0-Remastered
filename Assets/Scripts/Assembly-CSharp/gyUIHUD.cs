...
public class gyUIHUD : MonoBehaviour
{
	...
	protected void UpdateWidth()
	{
		...
		float num2 = (m_fWidth - num) * 0.5f;
		m_Left.transform.localPosition = new Vector3((0f - x3) * 0.5f - x * 0.5f - num2, m_Left.transform.localPosition.y, m_Left.transform.localPosition.z);
		m_Right.transform.localPosition = new Vector3(x3 * 0.5f + x2 * 0.5f + num2, m_Right.transform.localPosition.y, m_Right.transform.localPosition.z);
		m_LeftLine.transform.localScale = new Vector3(num2, m_LeftLine.transform.localScale.y, m_LeftLine.transform.localScale.z);
		m_LeftLine.transform.localPosition = new Vector3((0f - x3) * 0.5f - num2 * 0.5f, m_LeftLine.transform.localPosition.y, m_LeftLine.transform.localPosition.z);
		m_RightLine.transform.localScale = new Vector3(num2, m_RightLine.transform.localScale.y, m_RightLine.transform.localScale.z);
		m_RightLine.transform.localPosition = new Vector3(x3 * 0.5f + num2 * 0.5f, m_RightLine.transform.localPosition.y, m_RightLine.transform.localPosition.z);
	}
}
